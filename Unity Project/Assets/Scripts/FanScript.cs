...
public class FanScript : MonoBehaviour {
    ...
    */
    ...
    void OnTriggerEnter(Collider other)
    {
        if (destructable)
        {
            if (other.gameObject.CompareTag("LaserLVL1") || other.gameObject.CompareTag("LaserLVL2") || other.gameObject.CompareTag("LaserLVL3") || other.gameObject.CompareTag("LaserLVL4") || other.gameObject.CompareTag("Gauss") || other.gameObject.CompareTag("Missle"))
            {
